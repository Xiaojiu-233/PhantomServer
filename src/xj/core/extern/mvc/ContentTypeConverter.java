...
import xj.implement.mvc.DataFormContentTypeHandler;
import xj.implement.mvc.XwwwFormContentTypeHandler;
...
public class ContentTypeConverter {
    ...
    public ContentTypeConverter(){
        ...
        handlerList.add(new XwwwFormContentTypeHandler());
        handlerList.add(new DataFormContentTypeHandler());
        handlerList.add(new FileContentTypeHandler());

    }

    // 根据提供的请求数据与ContentType，处理返回对应的Map数据
    public Map<String,Object> handleData(ContentType contentType,Map<String, String> args, byte[] data){
